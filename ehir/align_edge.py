...
from .base import file_name, imread, imsave, Image, transform_img
from .base import get_bbox, get_edge, get_bbox_H
...
def align_edge(moving, fixed, init_bbox=None, moving_mask=None, tform_tp='projective', sim_no_scale=False, optim='adam', lr=3e-3, H_sx=1, H_sy=1, max_iters=200, max_patience=5, lr_gamma=0.9, lr_sched_step=30, max_dist=100, abs_tol=1e-3, err_th=None, msg_prefix='', dev='cuda:0', verbose=True, **kws):
    # 0: moving_inside
    ...
    for cur_iter in range(max_iters):
        ...
        sampled_values = F.grid_sample(t_fixed_distmap, grid, padding_mode='border').squeeze()
